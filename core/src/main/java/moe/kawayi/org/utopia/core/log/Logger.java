...
public interface Logger extends System.Logger {
    ...
    @Override
    default void log(
            @NotNull Level level, @Nullable ResourceBundle bundle, @NotNull String msg, @Nullable Throwable thrown) {
        Objects.requireNonNull(level);
        ...
        BiConsumer<Consumer<String>, BiConsumer<String, Throwable>> log =
                log = (Consumer<String> logFunc, BiConsumer<String, Throwable> throwFunc) -> {
                    if (thrown == null) logFunc.accept(msg);
                    else throwFunc.accept(msg, thrown);
                };
    ...
    @Override
    default void log(
            @NotNull Level level, @Nullable ResourceBundle bundle, @NotNull String format, @NotNull Object... params) {
        Objects.requireNonNull(level);
